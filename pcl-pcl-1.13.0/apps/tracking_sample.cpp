...
void filterPassThrough (const CloudConstPtr &cloud, Cloud &result)
{
  ...
  //included by Yejin - changed to XYZ
...
drawParticles (pcl::visualization::PCLVisualizer& viz)
{
  ...
  //included by Yejin
  std::cout << "checking what is inisde particles_in drawParticles function " <<*particles << std::endl;
  ...
  if (particles && new_cloud_)
  {
    ...
    for (const auto& particle: *particles)
	{
	  ...
	  //what is inside particle_cloud. Need to Check.
	}
...
drawResult (pcl::visualization::PCLVisualizer& viz)
{
  ...
  //for check_yejin
  //result = tracker_->getSearchMethod ();

  //included by Yejin
  //ParticleXYZ result = tracker_->getResult ();
  
  //checking what is inside tracker_Yejin:
  std::cout << "checking what is inside tracker_getResult_yejin" << result << std::endl;  
  Eigen::Affine3f transformation = tracker_->toEigenMatrix (result);
  
  //checking_Yejin
  //ParticleXYZRPY result2 = tracker_->getReferenceCloud();
  //std::cout << "checking what is inside reference cloud_yejin" << *result2 << std::endl;

  //inserted by Yejin for checking 
  std::cout << "check the reference cloud for tracker" << *(tracker_->getReferenceCloud()) << std::endl;
...
main (int argc, char** argv)
{
  ...
  std::cout << "checking target-cloud - YEjin: " << *target_cloud << std::endl;
  //check inside point[] data.
  //std::cout << "checking target-cloud - Yejin: " << *(target_cloud.points) << std::endl;
  ...
  tracker_->setResampleLikelihoodThr(0.50);
  ...
  //checking - by Yejin
  std::cout << "checking_by Yejin" << c[0] << std::endl;
  std::cout << "checking_by Yejin" << c[1] << std::endl;
  std::cout << "checking_by Yejin" << c[2] << std::endl;
  ...
  pcl::io::OpenNI2Grabber* interface = new pcl::io::OpenNI2Grabber(device_id);
